...
class CurrentUserExtention implements QueryCollectionExtensionInterface, QueryItemExtensionInterface 
{
	...
	function __construct(Security $security, AuthorizationCheckerInterface $checker)
	{
	...
	{	
		//1. Obtenir l'utilisateur connecter
		$user = $this->security->getUser();

		//2. Si demande invoice ou customer donner celle de l'User connecter 
		if (
